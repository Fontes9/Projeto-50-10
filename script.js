/* =========================================
   LÓGICA DO LOGIN / REGISTO
   ========================================= */

// Trocar entre os separadores "Entrar" e "Registar"
...
// Simular entrada no sistema e redirecionar para a dashboard
...
/* =========================================
   LÓGICA DO PORTAL / DASHBOARD (coaching/horários)
   ========================================= */

// 1. NAVEGAÇÃO ENTRE ABAS DO PORTAL
...
// 2. CÁLCULO DE PREÇO DO COACHING
function calculatePrice() {
    const typeSelect = document.getElementById('coachType');
    const durationSelect = document.getElementById('duration');
    const priceDisplay = document.getElementById('priceDisplay');
    
    if (typeSelect && durationSelect && priceDisplay) {
        let hourlyRate = typeSelect.value === 'internal' ? 36 : 45;
        let finalPrice = (hourlyRate * parseInt(durationSelect.value)) / 60;
        priceDisplay.innerText = finalPrice.toFixed(2);
    }
}

// 3. SUBMISSÃO DE FORMULÁRIO DE COACHING E ADIÇÃO À TABELA
...
// 4. DUPLA VALIDAÇÃO (Professor / Encarregado confirma aula)
...
// 6. VERIFICAÇÃO DE HORÁRIO (ABERTO/FECHADO) E DESTAQUE NA GRELHA
function checkStatus() {
    if (!document.getElementById('currentStatus')) return;
